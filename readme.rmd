...
This is the core of the code. To find those positions it is a bit of a guessing game. So I downloaded a background tweet and went on testing the correct positions
...
Finally, we just need to write a nesterd loop to iterate over several parameters
